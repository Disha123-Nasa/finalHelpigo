        ...
        <nav className="navbar" id="navbar">
            <div className="navbar-container">
                ...
                <div className="navbar-buttons">
                    {!token?<button onClick={() => navigate("/login")} className="btn btn-outline">Log In</button>:""}
                    {!token?<button onClick={() => navigate("/signup")} className="btn btn-outline">Sign Up</button>:""}
                    <button onClick={() => navigate("/addtocart")} className="btn btn-outline"><FaShoppingCart /></button>
                    
                    {token?<button onClick={handleLogout} className="btn btn-outline">Logout</button>:""}
